...
<div class="col-start-4 col-end-10 border rounded">
    <div class="col-span-12 mt-2 p-5 border-b-2 text-center relative">
        <a class="bg-gray-400 p-2 rounded absolute top-3 left-5" href = "{{route('detail_back_home')}}">
            <button>Kembali</button>
        </a>
        <h1 class="text-2xl">Tambah Konten Detail</h1>
    </div>

    <form class="col-span-12 grid grid-cols-12 gap-4 p-5" method="POST" action="{{route('konten_detail.store')}}">
        @csrf
        <div class="col-span-12 grid grid-cols-12 gap-4 border-b-2 pb-3">
            <div class="col-span-10">
                <select class="border w-full p-2 rounded" aria-label="objek" name="objek">
                    <option selected disabled>Open this select menu</option>
                    @foreach($konten_baru as $konten)
                        <option value="{{$konten->id_konten}}">{{$konten->nama_konten}}</option>
                    @endforeach
            ...
            <div class="col-span-2">
                <button type = "submit" class = "bg-green-400 p-2 rounded w-full"> Simpan Semua </button>
            </div>
        </div>
        ...
        <div class = "col-span-12 grid grid-cols-12 gap-4">
            <a href = "{{route('detail_content_create_judul',['id' => 0, 'id_konten' => 0, 'edit' => 0])}}" class = "col-span-3"> 
                <button type = "button" class = "bg-green-400 p-2 rounded w-full">Tambah Judul</button>
            </a>
            <a href = "{{route('detail_content_create_paragraf',['id' => 0, 'id_konten' => 0, 'edit' => 0])}}" class = "col-span-3"> 
                <button type = "button" class = "bg-green-400 p-2 rounded w-full">Tambah Paragraf</button>
            </a>
            <a href = "{{route('detail_content_create_gambar',['id' => 0, 'id_konten' => 0, 'edit' => 0])}}" class = "col-span-3"> 
                <button type = "button" class = "bg-green-400 p-2 rounded w-full">Tambah Gambar</button>
            </a>
            <a href = "{{route('detail_content_create_vidio',['id' => 0, 'id_konten' => 0, 'edit' => 0])}}" class = "col-span-3"> 
    ...
    <div class = "col-span-12 grid grid-cols-12 gap-4 p-5">
        @if($konten_detail_sementara)
            @foreach($konten_detail_sementara as $detail)
                ...
                <div class="col-span-12 grid grid-cols-12 gap-4 p-2 border rounded ">
                    ...
                    <div class="grid grid-cols-12 gap-4 col-span-3">
                        <div class="col-span-6 w-full">
                            <a href = "{{ route('detail_content_create_judul',['id' => $detail->id, 'id_konten' => 0, 'edit' => 1]) }}">
                ...
                <div class="col-span-12 grid grid-cols-12 gap-4 p-2 border rounded ">
                    ...
                    <div class="grid grid-cols-12 gap-4 col-span-3">
                        <div class="col-span-6 w-full">
                        <a href = "{{ route('detail_content_create_paragraf',['id' => $detail->id, 'id_konten' => 0, 'edit' => 1]) }}">
                                <button class="bg-green-400 p-2 rounded w-full">Ubah</button>
                            </a>
                        </div>
                ...
                <div class="col-span-12 grid grid-cols-12 gap-4 p-2 border rounded ">
                    ...
                    <div class="grid grid-cols-12 gap-4 col-span-3">
                        <div class="col-span-6 w-full">
                        <a href = "{{ route('detail_content_create_gambar',['id' => $detail->id, 'id_konten' => 0, 'edit' => 1]) }}">
                                <button class="bg-green-400 p-2 rounded w-full">Ubah</button>
                            </a>
                        </div>
                ...
                <div class="col-span-12 grid grid-cols-12 gap-4 p-2 border rounded ">
                    ...
                    <div class="grid grid-cols-12 gap-4 col-span-3">
                        <div class="col-span-6 w-full">
                        <a href = "{{ route('detail_content_create_vidio',['id' => $detail->id, 'id_konten' => 0, 'edit' => 1]) }}">
                                <button class="bg-green-400 p-2 rounded w-full">Ubah</button>
                            </a>
                        </div>
