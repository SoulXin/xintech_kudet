...
@section('content')
<!-- Main -->
<div class="col-span-12 lg:col-start-3 lg:col-end-8 lg:border lg:rounded lg:mt-5 xl:col-start-4 xl:col-end-9 px-0 mt-3 md:mt-0 md:p-5" id="post-data-hardware">
    @include('client.sub_menu.hardware')
