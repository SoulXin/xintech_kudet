...
@foreach($konten as $isi_konten)
    <a href="{{ route('detail',['id'=>$isi_konten->id]) }}" class = "mb-10 relative grid grid-cols-12 gap-4 md:border">
        ...
        <img class="col-span-12 h-56 w-full md:col-start-1 md:col-end-5 md:h-40 lg:h-24 xl:h-36" src="{{ url('gambar/banner/' . $isi_konten->banner_konten)}}"/>
        <div class=" ml-3 mb-2 mt-0 col-span-12 md:col-start-5 md:col-end-11">
            ...
            <p class="italic">{{ $isi_konten->created_at }}</p>
        </div>
...
@endforeach
@else
    <h1 class="text-center text-xl md:text-3xl lg:text-4xl text-gray-400 mt-10">Tidak Ditemukan</h1>
@endif
